...
import { useDeleteStaffMutation, useLazyGetStaffQuery } from '@org/store';
import {
  Button,
  H2,
  IconDeleteAction,
...
function StaffApp() {
  ...
  useEffect(() => {
    ...
    dispatch(setActiveSubGroup({ current: SiteMap.Users.Staff.menu }));
    return () => {
      dispatch(clearActiveMenu());
    };
  }, []);

  const [getUser, { data, isLoading }] = useLazyGetStaffQuery();
