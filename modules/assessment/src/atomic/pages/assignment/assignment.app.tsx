...
import { useDeleteAssignmentMutation, useLazyGetAssignmentQuery } from '@org/store';
import {
  Button,
  H2,
  IconDeleteAction,
...
function AssignmentApp() {
  ...
  useEffect(() => {
    ...
    dispatch(setActiveSubGroup({ current: SiteMap.Assessment.Assignment.menu }));
    return () => {
      dispatch(clearActiveMenu());
    };
  }, []);

  const [getUser, { data, isLoading }] = useLazyGetAssignmentQuery();
