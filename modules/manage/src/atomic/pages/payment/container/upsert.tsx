...
export function Upsert() {
  ...
  const [createData, { isLoading: isLoadingCreate }] = useCreatePaymentMutation();

  const [getData, { isLoading: isLoadingGet }] = useLazyFindPaymentQuery();

  const [updateUser, { isLoading: isLoadingUpdate }] = useUpdatePaymentMutation();
