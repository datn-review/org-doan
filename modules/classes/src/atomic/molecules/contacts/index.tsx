...
export function Contants({ data, type, close, refetch }: IProps) {
  ...
  return (
    <ModalAntd
      title={type === EnumTypeContact.View ? t('contact.title.link') : t('contact.title.success')}
      open={!!data}
      onCancel={close}
      width={'90%'}
      className={css`
      ...
      <FormProvider {...methods}>
        <Space ref={componentRef}>
          ...
          <Space>
            ...
            <br />
            1. Gia sư đến trực tiếp văn phòng trung tâm gia sư Tài Năng Trẻ tại địa chỉ : 1269/17
            Phạm Thế Hiển, P5, Quận 8 để ký hợp đồng, đóng phí nhận lớp và nhận giấy giới thiệu trực
            tiếp.
            <br />
            2. Gia sư nhận lớp qua hình thức online. Gia sư sẽ gửi phí nhận lớp qua các tài khoản
            ngân hàng của trung tâm cung cấp bên trên. Giấy giới thiệu và hợp đồng sẽ được gửi qua
            tài khoản gia sư tại website daykemtainha.vn.
            <br />
            <br />
            Gia sư nhận lớp qua một trong hai hình thức trên đều sẽ chấp hành theo các điều khoản
            của hợp đồng giao ( nhận) lớp dưới đây:
            <br />
            ...
            - Đóng 25 - 30% của học phí tháng đầu tiên đối với các môn học văn hóa từ cấp tiểu học
            đến THPT (toán, lý, hóa, sinh, văn, tiểu học …)
            <br />
            <br />
            Điều 2: Khi đến gặp phụ huynh, Bên B vui lòng xuất trình với phụ huynh, Giấy giới thiệu
            (bắt buộc). <br />
            <br />
            Điều 3: Sau khi trung tâm cung cấp số điện thoại và địa chỉ của phụ huynh – học viên,
            Bên B phải alo hẹn gặp ngay. Khi gặp sự cố ( vì bất cứ lý do gì mà không tiến hành học:
            không dạy ngay, lùi ngày học,hay bất kỳ một lý do nào dù nhỏ nhất) phải báo cho Bên A
            khi bạn đang ở nhà phụ huynh hoặc vừa ra khỏi nhà phụ huynh.Các bạn gọi theo số điện
            thoại này từ Thứ 2-Chủ nhật 24/24 : 090 333 1985 hoặc 09 87 87 0217
            <br />
            <br />
            ...
            <br />
            <br />
            Điều 5: Sau 1 tháng đầu tiên, hợp đồng này chấm dứt. Nếu trong tháng đầu lỗi do phu
            huynh học viên trung tâm sẽ giải quyết cho gia sư dựa vào từ thời điểm nhận lớp đến thới
            điểm gia sư báo sự cố.
            <br />
            <br />
            <br />
            <b>Bên A : Phía trung tâm gia sư Tài Năng Trẻ </b>
            <br />
            Điều 6: Sau khi nhận phí Bên A sẽ cung cấp địa chỉ, số điện thoại của PHHS trên giấy
            giới thiệu và gọi điện báo thông tin của bên B cho Phụ huynh.
            <br />
            <br />
            ...
            <br />
            <br />
            3/ Nếu Bên B: Thay đổi bất kỳ điều khoản ban đầu (PH đồng ý mà Bên B không dạy, đi trễ
            về sớm,hẹn phụ huynh mà không đến đúng hẹn,tự ý gọi lại phụ huynh đổi lịch hẹn, lấy lý
            do xa quá, tăng lương,hoặc đau ốm,có người thân nhập viện trả lớp,tự ý thương lượng mức
            lương khi phụ huynh yêu cầu,tăng số buổi dạy,tăng số học sinh so với hợp đồng ban đầu,
            không liên hệ phụ huynh ngay dẫn đến tình trạng mất lớp, dạy vài buổi đòi phụ huynh đóng
            tiền.…)
