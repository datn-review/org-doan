...
export function Upsert() {
  ...
  const [createData, { isLoading: isLoadingCreate }] = useCreateSkillsMutation();

  const [getData, { isLoading: isLoadingGet }] = useLazyFindSkillsQuery();

  const [updateUser, { isLoading: isLoadingUpdate }] = useUpdateSkillsMutation();
