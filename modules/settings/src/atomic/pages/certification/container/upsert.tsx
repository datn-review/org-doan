...
export function Upsert() {
  ...
  const [getData, { isLoading: isLoadingGet }] = useLazyFindCertificationQuery();

  const [updateUser, { isLoading: isLoadingUpdate }] = useUpdateCertificationMutation();
  ...
  return (
    <>
      ...
      {isUpsert && (
        <Drawer
          title={idEdit ? t('certification.edit.title') : t('certification.add.title')}
          placement={'right'}
          width={500}
          onClose={close}
          open={isUpsert}
